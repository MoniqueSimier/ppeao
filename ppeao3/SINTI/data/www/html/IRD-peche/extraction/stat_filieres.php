...
if(isset($_POST['case1']))
	...
	{
	print("<div align='center'>");
	print("<br>Choix des variables du tableau Cap_tot :");
	...
	while (list($key, $val) = each($_POST['periode']))
				...
				//print ("<br>!!!!".$key." , ".$val);
				//$query_globale .= " and art_activite.annee =".$key." ";
				$query_globale .= "and (";
				while (list($key2, $val2)= each($val))
					{
					//$query_globale .= ("<br>annee".$key."periode : ".$val2." , ");
	...
	print ("<table CELLPADDING=15><tr ><td VALIGN=top>");
	print ("<table BORDER=1 CELLSPACING=2 CELLPADDING=1 WIDTH=\"200\"><CAPTION ALIGN=TOP>Pays :</CAPTION>");
	//pour le pays
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[1]\" value=\"1\" checked disabled></td><td>id</td>");//id pays
	print ("<input type=hidden name=\"voir[1]\" value=\"1\">");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[2]\" value=\"2\" checked disabled></td><td>libellé</td>");//nom pays
	print ("<input type=hidden name=\"voir[2]\" value=\"2\">");

	print ("</tr></table></td><td>");
	

	print ("<table BORDER=1 CELLSPACING=2 CELLPADDING=1 WIDTH=\"200\"><CAPTION ALIGN=TOP>Système :</CAPTION>");
	//pour le systeme
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[3]\" value=\"3\" checked disabled></td><td>id</td>");
	print ("<input type=hidden name=\"voir[3]\" value=\"3\">");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[4]\" value=\"4\" checked disabled></td><td>libellé</td>");
	print ("<input type=hidden name=\"voir[4]\" value=\"4\">");
	print ("</tr></table></td></tr><tr><td>");
	
	print ("<table BORDER=1 CELLSPACING=2 CELLPADDING=1 WIDTH=\"200\"><CAPTION ALIGN=TOP>Secteur :</CAPTION>");
	//pour le secteur
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[5]\" value=\"8\" checked disabled></td><td>id dans système</td>");
	print ("<input type=hidden name=\"voir[5]\" value=\"8\">");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[6]\" value=\"9\" checked disabled></td><td>nom</td>");
	print ("<input type=hidden name=\"voir[6]\" value=\"9\">");
	print ("</tr></table></td><td>");
	
	print ("<table BORDER=1 CELLSPACING=2 CELLPADDING=1 WIDTH=\"200\"><CAPTION ALIGN=TOP>Agglomérations :</CAPTION>");
	//pour les agglomerations
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[7]\" value=\"12\" checked disabled></td><td>id</td>");
	print ("<input type=hidden name=\"voir[7]\" value=\"12\">");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[8]\" value=\"15\" checked disabled></td><td>nom</td>");
	print ("<input type=hidden name=\"voir[8]\" value=\"15\">");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[9]\" value=\"20\" checked></td><td>type</td>");
	print ("</tr></table></td></tr></table>");
	
	//pour les statistiques totales
	print ("<table BORDER=1 CELLSPACING=2 CELLPADDING=1 WIDTH=\"200\"><CAPTION ALIGN=TOP>Statistiques totales :</CAPTION>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\"  checked disabled></td><td>année</td>");
	print ("<input type=hidden name=\"voir[10]\" value=\"22\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>mois</td>");
	...
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>pue</td>");
	...
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>Fm</td>");
	print ("<input type=hidden name=\"voir[19]\" value=\"30\">");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>Cap</td>");
...
//print ("<br><br><a href=\"http://vmppeao.intranet.mpl.ird.fr/extraction/temp_selection_globale.txt.gz\"<b>Enregistrement du fichier texte</b></a>");
...
$bdd = "jerome_manant";
	...
	{
	print("<div align='center'>");
	print("<br>Choix des variables du tableau Cap_sp :<br>");
	...
	$i = 0;
	$k=1;//nombre lignes
	$intitule = "numero\t pays\t pays_lib\t syst\t syst_lib\t refpaysid\t syst_surf\t idsecteur\t sect\t sect_lib\t sect_surf\t refsystemeid\t agglo\t type_agglo\t sect\t agglo_lib\t agglo_long\t agglo_lat\t mmagglo\t idtype_agglo\t type_agglo\t stat_tot_id\t annee\t mois\t nbre_obs\t obs_min\t obs_max\t pue_ecart_type\t pue\t fpe\t fm\t cap\t art_agglo_id\t nb_unite_recencee\t nb_jour_activite\t id\t obs_sp_min\t obs_sp_max\t pue_sp_ecart_type\t pue_sp	cap_sp\t ref_espece_id\t art_stat_totale_id\t nbre_enquete_sp\t id\t libelle\t info\t ref_famille_id\t ref_categorie_ecologique_id\t ref_categorie_trophique_id\t coefficient_k\t coefficient_b\t ref_origine_kb_id\t ref_espece_id\t id\t libelle\t id\t libelle\t id\t libelle\t ref_ordre_id\t non_poisson\t id\t libelle\n";
	fputs($fpm,$intitule);
	$nombre_enreg = pg_num_rows($result);
	...
	while($row = pg_fetch_row($result))
		...
		//si $row[0]different, numero +1
		for ($i=0; $i<63; $i++)	//il y a 63 champs dans la requete
			{
			$contenu .= trim($row[$i])."\t";
			}
		//$contenu .= $row[0]."\t".$row[1]."\t".$row[2]."\t".$row[3]."\t".$row[4]."\t".$row[5]."\t";
	...
	print ("<table BORDER=1 CELLSPACING=2 CELLPADDING=1 WIDTH=\"200\"><CAPTION ALIGN=TOP>Statistiques espèces :</CAPTION>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\"  checked disabled></td><td>année</td>");
	print ("<input type=hidden name=\"voir[10]\" value=\"22\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>mois</td>");
	print ("<input type=hidden name=\"voir[11]\" value=\"23\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[12]\" value=\"35\" ></td><td>id</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>pue_sp</td>");
	print ("<input type=hidden name=\"voir[13]\" value=\"39\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[14]\" value=\"38\" ></td><td>pue_sp_ecart_type</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[15]\" value=\"36\" ></td><td>obs_sp_min</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[16]\" value=\"37\" ></td><td>obs_sp_max</td>");
	...
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>pue_sp</td>");
	print ("<input type=hidden name=\"voir[20]\" value=\"39\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>cap_sp</td>");
	print ("<input type=hidden name=\"voir[21]\" value=\"40\">");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>espece</td>");
	print ("<input type=hidden name=\"voir[22]\" value=\"44\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[23]\" value=\"45\" ></td><td>espece_libelle</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[24]\" value=\"43\" ></td><td>nbre_enquete_sp</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[25]\" value=\"59\" ></td><td>famille</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[26]\" value=\"63\" ></td><td>ordre</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[27]\" value=\"55\" ></td><td>cat_ecol</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[28]\" value=\"57\" ></td><td>cat_troph</td>");
...
$bdd = "jerome_manant";
	...
	{
	print("<div align='center'>");
	print("<br>Choix des variables du tableau DFT_sp :<br>");
	...
	$i = 0;
	$k=1;//nombre lignes
	$intitule = "numero\t pays\t pays_lib\t syst\t syst_lib\t refpaysid\t syst_surf\t idsecteur\t sect\t sect_lib\t sect_surf\t refsystemeid\t agglo\t type_agglo\t sect\t agglo_lib\t agglo_long\t agglo_lat\t mmagglo\t idtype_agglo\t type_agglo\t stat_tot_id\t annee\t mois\t nbre_obs\t obs_min\t obs_max\t pue_ecart_type\t pue\t fpe\t fm\t cap\t art_agglo_id\t nb_unite_recencee\t nb_jour_activite\t id\t obs_sp_min\t obs_sp_max\t pue_sp_ecart_type\t pue_sp	cap_sp\t ref_espece_id\t art_stat_totale_id\t nbre_enquete_sp\t id\t libelle\t info\t ref_famille_id\t ref_categorie_ecologique_id\t ref_categorie_trophique_id\t coefficient_k\t coefficient_b\t ref_origine_kb_id\t ref_espece_id\t id\t libelle\t id\t libelle\t id\t libelle\t ref_ordre_id\t non_poisson\t id\t libelle\t id\t li\t xi\t art_stat_sp_id\n";
	fputs($fpm,$intitule);
	$nombre_enreg = pg_num_rows($result);
	...
	while($row = pg_fetch_row($result))
		...
		//si $row[0]different, numero +1
		for ($i=0; $i<67; $i++)	//il y a 67 champs dans la requete
			{
			$contenu .= trim($row[$i])."\t";
			}
		//$contenu .= $row[0]."\t".$row[1]."\t".$row[2]."\t".$row[3]."\t".$row[4]."\t".$row[5]."\t";
	...
	//pour les statistiques especes
	print ("<table BORDER=1 CELLSPACING=2 CELLPADDING=1 WIDTH=\"200\"><CAPTION ALIGN=TOP>Statistiques espèces et structures de tailles :</CAPTION>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\"  checked disabled></td><td>année</td>");
	print ("<input type=hidden name=\"voir[10]\" value=\"22\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>mois</td>");
	print ("<input type=hidden name=\"voir[11]\" value=\"23\">");
	...
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>pue_sp</td>");
	print ("<input type=hidden name=\"voir[13]\" value=\"39\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>li</td>");
	print ("<input type=hidden name=\"voir[14]\" value=\"65\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>xi</td>");
	print ("<input type=hidden name=\"voir[15]\" value=\"66\">");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[16]\" value=\"64\" ></td><td>id taille</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[17]\" value=\"31\" ></td><td>cap_tot</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[18]\" value=\"30\" ></td><td>Fm_tot</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[19]\" value=\"28\" ></td><td>pue_tot</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>pue_sp</td>");
...
if(isset($_POST['case4']))
	...
	$i = 0;
	$k=1;//nombre lignes
	$intitule = "numero\t pays\t pays_lib\t syst\t syst_lib\t refpaysid\t syst_surf\t idsecteur\t sect\t sect_lib\t sect_surf\t refsystemeid\t agglo\t type_agglo\t sect\t agglo_lib\t agglo_long\t agglo_lat\t mmagglo\t idtype_agglo\t type_agglo\t stat_tot_id\t annee\t mois\t nbre_obs\t obs_min\t obs_max\t pue_ecart_type\t pue\t fpe\t fm\t cap\t art_agglo_id\t nb_unite_recencee\t nb_jour_activite\t id\t obs_gt_min\t obs_gt_max\t pue_gt_ecart_type\t pue_gt\t fpe_gt\t fm_gt\t cap_gt\t art_grand_type_engin_id\t art_stat_totale_id\t nbre_enquete_gt\t id\t libelle\n";
	fputs($fpm,$intitule);
	$nombre_enreg = pg_num_rows($result);
	...
	while($row = pg_fetch_row($result))
		...
		//si $row[0]different, numero +1
		for ($i=0; $i<47; $i++)	//il y a 47 champs dans la requete
			{
			$contenu .= trim($row[$i])."\t";
			}
		//$contenu .= $row[0]."\t".$row[1]."\t".$row[2]."\t".$row[3]."\t".$row[4]."\t".$row[5]."\t";
	...
	///////////////////////////////////////
	//print ("<div align='center'>");
	print ("<br>Le fichier texte comporte ".($k-1)." lignes");//car 1ere ligne est un intitulé
	...
	//pour les statistiques gt
	print ("<table BORDER=1 CELLSPACING=2 CELLPADDING=1 WIDTH=\"200\"><CAPTION ALIGN=TOP>Statistiques grand type :</CAPTION>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\"  checked disabled></td><td>année</td>");
	print ("<input type=hidden name=\"voir[10]\" value=\"22\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>mois</td>");
	print ("<input type=hidden name=\"voir[11]\" value=\"23\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[12]\" value=\"35\" ></td><td>id</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>pue_gt</td>");
	print ("<input type=hidden name=\"voir[13]\" value=\"39\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[14]\" value=\"38\" ></td><td>pue_gt_ecart_type</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[15]\" value=\"36\" ></td><td>obs_gt_min</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[16]\" value=\"37\" ></td><td>obs_gt_max</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[17]\" value=\"31\" ></td><td>cap_tot</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[18]\" value=\"30\" ></td><td>Fm_tot</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[19]\" value=\"45\" ></td><td>nbre_enquete_gt</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>pue_tot</td>");
	print ("<input type=hidden name=\"voir[20]\" value=\"28\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>cap_gt</td>");
	print ("<input type=hidden name=\"voir[21]\" value=\"42\">");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>fm_gt</td>");
	print ("<input type=hidden name=\"voir[22]\" value=\"41\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[23]\" value=\"40\" checked disabled></td><td>fpe_gt</td>");
	print ("<input type=hidden name=\"voir[23]\" value=\"40\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[24]\" value=\"43\" checked disabled></td><td>grand_type_engin</td>");
	print ("<input type=hidden name=\"voir[24]\" value=\"43\">");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[25]\" value=\"45\"></td><td>grd_type_eng_lib</td>");
	print ("</tr></table>");
...
if(isset($_POST['case5']))
	...
	{
	print("<div align='center'>");
	print("<br>Choix des variables du tableau Cap_gt_sp :<br>");
	...
	$i = 0;
	$k=1;//nombre lignes
	$intitule = "numero\t pays\t pays_lib\t syst\t syst_lib\t refpaysid\t syst_surf\t idsecteur\t sect\t sect_lib\t sect_surf\t refsystemeid\t agglo\t type_agglo\t sect\t agglo_lib\t agglo_long\t agglo_lat\t mmagglo\t idtype_agglo\t type_agglo\t stat_tot_id\t annee\t mois\t nbre_obs\t obs_min\t obs_max\t pue_ecart_type\t pue\t fpe\t fm\t cap\t art_agglo_id\t nb_unite_recencee\t nb_jour_activite\t id\t obs_gt_min\t obs_gt_max\t pue_gt_ecart_type\t pue_gt\t fpe_gt\t fm_gt\t cap_gt\t art_grand_type_engin_id\t art_stat_totale_id\t nbre_enquete_gt\t id\t libelle\t id\t obs_gt_sp_min\t obs_gt_sp_max\t pue_gt_sp_ecart_type\t pue_gt_sp\t cap_gt_sp\t ref_espece_id\t art_stat_gt_id\t nbre_enquete_gt_sp\t id\t libelle\t info	ref_famille_id\t ref_categorie_ecologique_id\t ref_categorie_trophique_id\t coefficient_k\t coefficient_b\t ref_origine_kb_id\t ref_espece_id\t id\t libelle\t id\t libelle\t id\t libelle\t ref_ordre_id\t non_poisson\t id\t libelle\n";
	fputs($fpm,$intitule);
	$nombre_enreg = pg_num_rows($result);
	...
	while($row = pg_fetch_row($result))
		...
		//si $row[0]different, numero +1
		for ($i=0; $i<76; $i++)	//il y a 76 champs dans la requete
			{
			$contenu .= trim($row[$i])."\t";
			}
		//$contenu .= $row[0]."\t".$row[1]."\t".$row[2]."\t".$row[3]."\t".$row[4]."\t".$row[5]."\t";
	...
	//pour les statistiques gt
	print ("<table BORDER=1 CELLSPACING=2 CELLPADDING=1 WIDTH=\"200\"><CAPTION ALIGN=TOP>Statistiques grands types et espèces :</CAPTION>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\"  checked disabled></td><td>année</td>");
	print ("<input type=hidden name=\"voir[10]\" value=\"22\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>mois</td>");
	print ("<input type=hidden name=\"voir[11]\" value=\"23\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[12]\" value=\"35\" ></td><td>id</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>pue_gt_sp</td>");
	print ("<input type=hidden name=\"voir[13]\" value=\"52\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[14]\" value=\"51\" ></td><td>pue_gt_sp_ecart_type</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[15]\" value=\"49\" ></td><td>obs_gt_sp_min</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[16]\" value=\"50\" ></td><td>obs_gt_sp_max</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[17]\" value=\"31\" ></td><td>cap_tot</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[18]\" value=\"30\" ></td><td>Fm_tot</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[19]\" value=\"56\" ></td><td>nbre_enquete_gt_sp</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>cap_gt_sp</td>");
	print ("<input type=hidden name=\"voir[20]\" value=\"53\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>grand_type_engin</td>");
	print ("<input type=hidden name=\"voir[21]\" value=\"43\">");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[22]\" value=\"47\"></td><td>grd_type_eng_lib</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[23]\" value=\"57\" checked disabled></td><td>id espece</td>");
	print ("<input type=hidden name=\"voir[23]\" value=\"58\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[24]\" value=\"43\"></td><td>grand_type_engin</td>");
	print ("<input type=hidden name=\"voir[24]\" value=\"43\">");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[25]\" value=\"68\"></td><td>cat_eco</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[26]\" value=\"70\"></td><td>cat_troph</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[27]\" value=\"72\"></td><td>famille</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[28]\" value=\"76\"></td><td>ordre</td>");
	print ("</tr></table>");
...
$bdd = "jerome_manant";
	...
	{
	print("<div align='center'>");
	print("<br>Choix des variables du tableau DFT_gt_sp :<br>");
	...
	$i = 0;
	$k=1;//nombre lignes
	$intitule = "numero\t pays\t pays_lib\t syst\t syst_lib\t refpaysid\t syst_surf\t idsecteur\t sect\t sect_lib\t sect_surf\t refsystemeid\t agglo\t type_agglo\t sect\t agglo_lib\t agglo_long\t agglo_lat\t mmagglo\t idtype_agglo\t type_agglo\t stat_tot_id\t annee\t mois\t nbre_obs\t obs_min\t obs_max\t pue_ecart_type\t pue\t fpe\t fm\t cap\t art_agglo_id\t nb_unite_recencee\t nb_jour_activite\t id\t obs_gt_min\t obs_gt_max\t pue_gt_ecart_type\t pue_gt\t fpe_gt\t fm_gt\t cap_gt\t art_grand_type_engin_id\t art_stat_totale_id\t nbre_enquete_gt\t id\t obs_gt_sp_min\t obs_gt_sp_max\t pue_gt_sp_ecart_type\t pue_gt_sp\t cap_gt_sp\t ref_espece_id\t art_stat_gt_id\t nbre_enquete_gt_sp\t id\t libelle\t info\t ref_famille_id\t ref_categorie_ecologique_id\t ref_categorie_trophique_id\t coefficient_k\t coefficient_b\t ref_origine_kb_id\t ref_espece_id\t id\t libelle\t id\t libelle\t id\t libelle\t ref_ordre_id\t non_poisson\t id\t libelle\t id\t libelle\t id\t li\t xi\t art_stat_gt_sp_id\n";
	fputs($fpm,$intitule);
	$nombre_enreg = pg_num_rows($result);
	...
	while($row = pg_fetch_row($result))
		...
		//si $row[0]different, numero +1
		for ($i=0; $i<80; $i++)	//il y a 80 champs dans la requete
			{
			$contenu .= trim($row[$i])."\t";
			}
		//$contenu .= $row[0]."\t".$row[1]."\t".$row[2]."\t".$row[3]."\t".$row[4]."\t".$row[5]."\t";
	...
	print ("<td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>li</td>");
	print ("<input type=hidden name=\"voir[15]\" value=\"77\">");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" checked disabled></td><td>xi</td>");
	print ("<input type=hidden name=\"voir[16]\" value=\"78\">");
	
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[17]\" value=\"75\" checked disabled></td><td>engin_id</td>");
	print ("<input type=hidden name=\"voir[17]\" value=\"75\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[18]\" value=\"76\" ></td><td>engin_lib</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[19]\" value=\"55\" checked disabled></td><td>espece_id</td>");
	print ("<input type=hidden name=\"voir[19]\" value=\"55\">");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[20]\" value=\"56\"></td><td>esp_lib</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[21]\" value=\"70\"></td><td>famille</td>");
	print ("</tr><tr ALIGN=center><td WIDTH=30><input type=\"Checkbox\" name=\"voir[22]\" value=\"74\"></td><td>ordre</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[23]\" value=\"66\" ></td><td>cat_eco</td>");
	print ("<td WIDTH=30><input type=\"Checkbox\" name=\"voir[24]\" value=\"68\" ></td><td>cat_troph</td>");
