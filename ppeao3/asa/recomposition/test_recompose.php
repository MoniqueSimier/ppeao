...
//$bdd = "BD2_Peche";                    // Le nom de la base de données 
...
if ($nb == 0){$query = "select id, art_debarquement_id from art_fraction limit 1"; $result = pg_query($connection, $query);
//pg_close();
}
			...
			while($row = pg_fetch_row($result))
				...
				if ($nb >= 5)
					...
					if ($nb == 0){$query2 = "select id, art_debarquement_id from art_fraction limit 1"; $result2 = pg_query($connection, $query2);
					//pg_close();
					}
					...
					while($row2 = pg_fetch_row($result2))
						...
						if ($nb >= 5)
							...
							if ($info_deb[$key][$key2][3] == 12)   //si mois 12
								...
								if ($nb == 0){$query3 = "select id, art_debarquement_id from art_fraction limit 1"; $result3 = pg_query($connection, $query3); 
								//pg_close();
								}
								...
								while($row3 = pg_fetch_row($result3))
									...
									if ($nb >= 5)
										...
										if ($nb == 0){
										$query4 = "select id, art_debarquement_id from art_fraction limit 1";
										$result4 = pg_query($connection, $query4);
										//pg_close();
										}
										...
										while($row4 = pg_fetch_row($result4))
											...
											if ($nb >= 5)
												...
												if ($nb == 0){$query5 = "select id, art_debarquement_id from art_fraction limit 1"; $result5 = pg_query($connection, $query5);
												//												pg_close();
															}
												...
												while($row5 = pg_fetch_row($result5))
													...
													if ($nb >= 5)
														...
														if ($nb == 0){pg_free_result($result6);$query6 = "select id, art_debarquement_id from art_fraction limit 1"; $result6 = pg_query($connection, $query6);
														//pg_close();
														}
														...
														while($row6 = pg_fetch_row($result6))
															...
															$deb_concerné = $row6[1];
																...
																if ($nb == 0){$query7 = "select id, art_debarquement_id from art_fraction limit 1"; $result7 = pg_query($connection, $query7);
																//pg_close();
																}
																...
																while($row7 = pg_fetch_row($result7))
																	...
																	if ($nb >= 5)
																		...
																		if ($nb == 0){$query8 = "select id, art_debarquement_id from art_fraction limit 1"; $result8 = pg_query($connection, $query8);
																		//pg_close();
																		}
																		...
																		while($row8 = pg_fetch_row($result8))
																			...
																			if ($nb >= 5)
																				...
																				if ($nb == 0){$query9 = "select id, art_debarquement_id from art_fraction limit 1"; $result9 = pg_query($connection, $query9);
																				//pg_close();
																				}
																				...
																				while($row9 = pg_fetch_row($result9))
																					...
																					if ($nb >= 5)
																						...
																						if ($nb == 0){$query10 = "select id, art_debarquement_id from art_fraction limit 1"; $result10 = pg_query($connection, $query10);
																						//pg_close();
																						}
							...
							if ($info_deb[$key][$key2][3] == 12)   //si mois 12
								...
								while($row3 = pg_fetch_row($result3))
									...
									if ($nb >= 5) 
										...
										//si aucun resultat, on fait une nouvelle requete qui donne 1 seul resultat pour rentrer dans la boucle suivante
										$nb = pg_num_rows($result4);
										if ($nb == 0){$query4 = "select id, art_debarquement_id from art_fraction limit 1"; $result4 = pg_query($connection, $query4);
										//pg_close();
										}
											...
											if ($nb >= 5)
												...
												while($row5 = pg_fetch_row($result5))
													...
													//absence structure de taille ds le secteur
														...
														//si aucun resultat, on fait une nouvelle requete qui donne 1 seul resultat pour rentrer dans la boucle suivante
														$nb = pg_num_rows($result6);
														if ($nb == 0){$query6 = "select id, art_debarquement_id from art_fraction limit 1"; $result6 = pg_query($connection, $query6);
														//pg_close();
														}
...
$Wti =0;
	...
	//$connection =pg_connect ("host=".$host." dbname=".$bdd." user=".$user." password=".$passwd);
	//if (!$connection) {  echo "pas de connection2 "; exit;}
...
<div align='center'>
<Font Color ="#333366">
<br><br><b>Recompositions terminées</b><br>
</div>
</Font>
<br>
