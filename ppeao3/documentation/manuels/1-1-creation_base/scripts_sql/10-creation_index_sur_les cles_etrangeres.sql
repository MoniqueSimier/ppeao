...
CREATE INDEX art_stat_effort_art_grand_type_engin_id_index ON art_stat_effort USING btree (art_grand_type_engin_id);
CREATE INDEX art_stat_effort_art_param_type_effort_id_index ON art_stat_effort USING btree (art_param_type_effort_id);
CREATE INDEX art_stat_effort_ref_mois_id_index ON art_stat_effort USING btree (ref_mois_id);
CREATE INDEX art_stat_effort_ref_secteur_id_index ON art_stat_effort USING btree (ref_secteur_id);
CREATE INDEX art_stat_effort_ref_systeme_id_index ON art_stat_effort USING btree (ref_systeme_id);
