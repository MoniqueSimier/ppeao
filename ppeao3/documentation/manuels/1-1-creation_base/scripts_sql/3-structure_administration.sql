--
-- Script permettant de créer la structure des tables d'administration de l'application Web PPEAO
--
...
COMMENT ON COLUMN admin_sequences.table_db IS 'nom de la table à laquelle la séquence est attachée';
