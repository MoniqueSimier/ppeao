...
INSERT INTO admin_dictionary_tables VALUES (3, 'lieu_peche', 'lieux de pêche', 'art_lieu_de_peche', 'id', 'libelle', 4, 1, 'pays,systeme,secteur,lieu_peche', false, 2, true);
INSERT INTO admin_dictionary_tables VALUES (4, 'agglomeration', 'agglomération', 'art_agglomeration', 'id', 'nom', 3, 1, 'pays,systeme,secteur,agglomeration', true, 1, true);
INSERT INTO admin_dictionary_tables VALUES (5, 'csp', 'catégorie socio-professionnelle', 'art_categorie_socio_professionnelle', 'id', 'libelle', 3, 1, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (6, 'etat_ciel', 'état du ciel', 'art_etat_ciel', 'id', 'libelle', 3, 1, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (7, 'grand_type_engin', 'grands types d''engins', 'art_grand_type_engin', 'id', 'libelle', 3, 1, 'grand_type_engin,type_engin', true, 1, false);
INSERT INTO admin_dictionary_tables VALUES (8, 'milieu', 'milieux', 'art_millieu', 'id', 'libelle', 3, 1, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (9, 'type_activite', 'type d''activité', 'art_type_activite', 'id', 'raison', 3, 1, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (10, 'type_agglomeration', 'types d''agglomérations', 'art_type_agglomeration', 'id', 'libelle', 3, 1, NULL, false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (11, 'type_engin', 'types d''engins', 'art_type_engin', 'id', 'libelle', 3, 1, '', true, 1, false);
INSERT INTO admin_dictionary_tables VALUES (12, 'type_sortie', 'types de sorties', 'art_type_sortie', 'id', 'libelle', 3, 1, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (13, 'vent', 'vent', 'art_vent', 'id', 'libelle', 3, 1, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (14, 'contenu', 'contenu stomacal', 'exp_contenu', 'id', 'libelle', 3, 2, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (15, 'debris', 'débris', 'exp_debris', 'id', 'libelle', 3, 2, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (16, 'engins', 'engin', 'exp_engin', 'id', 'libelle', 3, 2, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (17, 'force_courant', 'force du courant', 'exp_force_courant', 'id', 'libelle', 3, 2, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (18, 'position', 'positions', 'exp_position', 'id', 'libelle', 3, 2, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (19, 'qualite_coup', 'qualité du coup', 'exp_qualite', 'id', 'libelle', 3, 2, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (20, 'remplissage', 'taux de remplissage stomacal', 'exp_remplissage', 'id', 'libelle', 3, 2, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (21, 'sediment', 'sédiment', 'exp_sediment', 'id', 'libelle', 3, 2, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (22, 'sens_courant', 'sens du courant', 'exp_sens_courant', 'id', 'libelle', 3, 2, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (23, 'sexe', 'sexe', 'exp_sexe', 'id', 'libelle', 3, 2, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (24, 'stade', 'stades de maturité', 'exp_stade', 'id', 'libelle', 3, 2, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (25, 'station', 'stations', 'exp_station', 'id', 'nom', 3, 2, 'pays,systeme,secteur,station', true, 1, false);
INSERT INTO admin_dictionary_tables VALUES (26, 'vegetation', 'végétation', 'exp_vegetation', 'id', 'libelle', 3, 2, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (27, 'ecologique', 'catégorie écologique', 'ref_categorie_ecologique', 'id', 'libelle', 2, 3, 'ecologique,espece', true, 1, false);
INSERT INTO admin_dictionary_tables VALUES (28, 'trophique', 'catégorie trophique', 'ref_categorie_trophique', 'id', 'libelle', 2, 3, 'trophique,espece', true, 1, false);
INSERT INTO admin_dictionary_tables VALUES (29, 'espece', 'espèces', 'ref_espece', 'id', 'libelle', 2, 3, '', false, 1, false);
INSERT INTO admin_dictionary_tables VALUES (30, 'famille', 'familles', 'ref_famille', 'id', 'libelle', 2, 3, 'ordre,famille,espece', true, 1, false);
INSERT INTO admin_dictionary_tables VALUES (31, 'ordre', 'ordres', 'ref_ordre', 'id', 'libelle', 2, 3, 'ordre,famille,espece', true, 1, false);
INSERT INTO admin_dictionary_tables VALUES (32, 'originekb', 'origines KB', 'ref_origine_kb', 'id', 'libelle', 2, 3, 'originekb,espece', true, 1, false);
INSERT INTO admin_dictionary_tables VALUES (33, 'pays', 'pays', 'ref_pays', 'id', 'nom', 2, 4, 'pays,systeme,secteur', true, 1, false);
INSERT INTO admin_dictionary_tables VALUES (34, 'secteur', 'secteurs', 'ref_secteur', 'id', 'nom', 2, 4, 'pays,systeme,secteur', true, 1, true);
INSERT INTO admin_dictionary_tables VALUES (35, 'systeme', 'systèmes', 'ref_systeme', 'id', 'libelle', 2, 4, 'pays,systeme', true, 1, true);
...
INSERT INTO admin_dictionary_tables VALUES (43, 'activite', 'activité', 'art_activite', 'id', 'id', 4, 1, 'pays,systeme,secteur,agglomeration,periode,activite', false, 2, false);
INSERT INTO admin_dictionary_tables VALUES (44, 'debarquement', 'débarquement', 'art_debarquement', 'id', 'id', 4, 1, 'pays,systeme,secteur,agglomeration,période,debarquement', false, 2, false);
INSERT INTO admin_dictionary_tables VALUES (45, 'engin_activite', 'engin-activité', 'art_engin_activite', 'id', 'id', 4, 1, 'pays,systeme,secteur,agglomeration,periode,activite,engin_activite', false, 2, false);
INSERT INTO admin_dictionary_tables VALUES (46, 'engin_peche', 'engin de pêche', 'art_engin_peche', 'id', 'id', 4, 1, 'pays,systeme,secteur,agglomeration,periode,debarquement,engin_peche', false, 2, false);
INSERT INTO admin_dictionary_tables VALUES (47, 'fraction_art', 'fractions artisanales', 'art_fraction', 'id', 'id', 4, 1, 'pays,systeme,secteur,agglomeration,periode,debarquement,fraction_art', false, 2, false);
INSERT INTO admin_dictionary_tables VALUES (48, 'poisson_mesure', 'poissons mesurés', 'art_poisson_mesure', 'id', 'id', 4, 1, 'pays,systeme,secteur,agglomeration,periode,debarquement,fraction_art,poisson_mesure', false, 2, false);
INSERT INTO admin_dictionary_tables VALUES (49, 'unite_peche', 'unités de pêche', 'art_unite_peche', 'id', 'libelle', 4, 1, 'pays,systeme,secteur,agglomeration,unite_peche', false, 2, true);
INSERT INTO admin_dictionary_tables VALUES (50, 'biologie', 'biologie', 'exp_biologie', 'id', 'id', 4, 2, 'pays,systeme,campagne,coup_peche,fraction_exp,biologie', false, 2, true);
INSERT INTO admin_dictionary_tables VALUES (51, 'campagne', 'campagne expérimentale', 'exp_campagne', 'id', 'numero_campagne', 4, 2, '', false, 2, false);
INSERT INTO admin_dictionary_tables VALUES (52, 'coup_peche', 'coup de pêche', 'exp_coup_peche', 'id', 'numero_coup', 4, 2, 'pays,systeme,campagne,coup_peche', false, 2, true);
INSERT INTO admin_dictionary_tables VALUES (53, 'environnement', 'environnement', 'exp_environnement', 'id', 'id', 4, 2, 'pays,systeme,campagne,coup_peche,environnement', false, 2, true);
INSERT INTO admin_dictionary_tables VALUES (54, 'fraction_exp', 'fractions expérimentales', 'exp_fraction', 'id', 'id', 4, 2, 'pays,systeme,campagne,coup_peche,fraction_exp', false, 2, true);
INSERT INTO admin_dictionary_tables VALUES (55, 'trophique_exp', 'trophique', 'exp_trophique', 'id', 'id', 4, 2, 'pays,systeme,campagne,coup_peche,fraction_exp,biologie,trophique_exp', false, 2, true);
