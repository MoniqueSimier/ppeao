...
CREATE TABLE art_agglomeration (
    id integer DEFAULT nextval('art_agglomeration_id_seq'::regclass) NOT NULL,
...
CREATE TABLE art_categorie_socio_professionnelle (
    id integer DEFAULT nextval('art_categorie_socio_professionnelle_id_seq'::regclass) NOT NULL,
...
CREATE TABLE art_etat_ciel (
    id integer DEFAULT nextval('art_etat_ciel_id_seq'::regclass) NOT NULL,
    libelle character varying(50)
);
...
CREATE TABLE art_type_agglomeration (
    id integer DEFAULT nextval('art_type_agglomeration_id_seq'::regclass) NOT NULL,
    libelle character varying(50)
);
...
CREATE TABLE art_type_sortie (
    id integer DEFAULT nextval('art_type_sortie_id_seq'::regclass) NOT NULL,
...
CREATE TABLE art_vent (
    id integer DEFAULT nextval('art_vent_id_seq'::regclass) NOT NULL,
    libelle character varying(50)
);
...
CREATE TABLE exp_contenu (
    id integer DEFAULT nextval('exp_contenu_id_seq'::regclass) NOT NULL,
    libelle character varying(50)
);
...
CREATE TABLE exp_force_courant (
    id integer DEFAULT nextval('exp_force_courant__seq'::regclass) NOT NULL,
    libelle character varying(50)
);
...
CREATE TABLE exp_position (
    id integer DEFAULT nextval('exp_position_id_seq'::regclass) NOT NULL,
    libelle character varying(50)
);
...
CREATE TABLE exp_qualite (
    id integer DEFAULT nextval('exp_qualite_id_seq'::regclass) NOT NULL,
    libelle character varying(100)
);
...
CREATE TABLE exp_sens_courant (
    id integer DEFAULT nextval('exp_sens_courant_id_seq'::regclass) NOT NULL,
    libelle character varying(50)
);
...
CREATE TABLE exp_stade (
    id integer DEFAULT nextval('exp_stade_id_seq'::regclass) NOT NULL,
    libelle character varying(50)
);
...
CREATE TABLE ref_famille (
    id integer DEFAULT nextval('ref_famille_id_seq'::regclass) NOT NULL,
    libelle character varying(50),
...
CREATE TABLE ref_ordre (
    id integer DEFAULT nextval('ref_ordre_id_seq'::regclass) NOT NULL,
    libelle character varying(50)
);
...
CREATE TABLE ref_origine_kb (
    id integer DEFAULT nextval('ref_origine_kb_id_seq'::regclass) NOT NULL,
    libelle character varying(50)
);
...
CREATE TABLE ref_systeme (
    id integer DEFAULT nextval('ref_systeme_id_seq'::regclass) NOT NULL,
    libelle character varying(50),
