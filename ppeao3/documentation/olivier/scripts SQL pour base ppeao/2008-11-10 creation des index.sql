...
CREATE INDEX admin_dictionary_tables_domain_id_index ON admin_dictionary_tables (domain_id);
CREATE INDEX admin_j_group_zone_group_id_index ON admin_j_group_zone (group_id);
CREATE INDEX admin_j_user_group_group_id_index ON admin_j_user_group (group_id);
CREATE INDEX admin_j_user_zone_user_id_index ON admin_j_user_zone (user_id);
