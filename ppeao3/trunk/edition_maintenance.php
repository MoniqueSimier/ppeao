...
<ul>
	<li><h2 style="margin : 0 0 6px 0"><a href="javascript:doMaintenance('sequences_ref_param');">Mise &agrave; jour des s&eacute;quences des tables de r&eacute;f&eacute;rence et de param&eacute;trage</a></h2>
	...
	<li><h2 style="margin : 6px 0 6px 0"><a href="javascript:doMaintenance('sequences_donnees');">Mise &agrave; jour des s&eacute;quences des tables de donn&eacute;es</a></h2>
	...
	<li><h2 style="margin : 6px 0 6px 0"><a href="javascript:doMaintenance('vacuum');">VACUUM</a></h2>
	<p>Utilisez cet outil apr&egrave;s avoir effectu&eacute; un grand nombre de suppressions dans la base de donn&eacute;es.</p>
	</li>
	<li><h2 style="margin : 6px 0 6px 0"><a href="javascript:doMaintenance('reindex');">REINDEX</a></h2>
	...
	<ul>
	<li><h2 style="margin : 0 0 6px 0"><a href="javascript:doMaintenance('disable_trigger');">D&eacute;sactiver des contraintes sur bdpeche</a></h2>
	<p>Utilisez cet outil pour supprimer temporairement les contraintes sur la base temporaire (bdpeche) contenant les donn&eacute;es &agrave; porter dans la base de r&eacute;f&eacute;rence (bdppeao).</p>
	</li>
	<li><h2 style="margin : 6px 0 6px 0"><a href="javascript:doMaintenance('enable_trigger');">Activer les contraintes sur bdpeche</a></h2>
	<p>Utilisez cet outil pour r&eacute;activer les contraintes sur la base temporaire (bdpeche) contenant les donn&eacute;es &agrave; porter dans la base de r&eacute;f&eacute;rence (bdppeao).</p>
	</li>	
    <li><h2 style="margin : 6px 0 6px 0"><a href="javascript:doMaintenance('empty_bdpeche');">Vider la base bdpeche</a></h2>
    <p>Utilisez cet outil pour vider la base temporaire bdpeche en supprimant les contraintes. </p>
    </li>
    <?php	if (!(strtoupper(substr(PHP_OS, 0, 3)) === 'WIN')) {?>
        <li>
        <h2 style="margin : 6px 0 6px 0"><a href="javascript:doMaintenance('empty_ACCESS');">Vider les bases PostgreSQL au format ACCESS</a></h2>
