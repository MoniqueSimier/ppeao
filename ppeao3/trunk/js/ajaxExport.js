...
function runProcess()
{
	...
	ctrlExec = document.getElementById("ctrlcheck").checked;
	...
	//testBDExec = document.getElementById("testcheck").checked;
	...
	document.getElementById("controleBase_img").innerHTML="<img src='/assets/ajax-loader_32px.gif' alt=''/>";
	document.getElementById("controleBase_txt").innerHTML="Controle base en cours";
	...
	var url="/export/export_gestionBD.php?tp="+typepeche+"&action=ctrl&log="+checkLog+"&exec="+ctrlExec;
	fenID = "controleBase";
...
{ 
	...
	{ 		
		...
		switch(numProcess)
		{
			...
			case 1:
				progPhp = "/export/export_gestionBD.php" ;
				nomFen = "vidage" ;
				nomURL = "tp="+typepeche+"&action=vide&log="+checkLog+"&numproc="+numProcess+"&exec="+videExec+URLSupp;
				texte = "Vidage de la base ACCESS de travail en cours...";
			  break;
			case 2:
			...
			//	progPhp = "/export/export_process.php" ;
			//	nomFen = "controleBD" ;
			//	nomURL = "tp="+typepeche+"&action=test&log="+checkLog+"&numproc="+numProcess+"&exec="+testBDExec+URLSupp;
			//	texte = "Compte rendu de controle de la base de travail ...";
			// break;
			case 4:
